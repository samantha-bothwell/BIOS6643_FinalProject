...
<ul>
  ...
  <li> Mean study days 546.6 (95\% CI: 324.8, 600.0) </li>
</ul>

## *Cohort 2 (N = 27)*
<ul>
  <li> 27 people beginning 02/13/2019 – 09/30/2019 (All but 2 began between 02/13/2020 – 02/16/2020) </li>
  <li> Ending between 12/22/2019 – 04/20/2020 (All but 2 ended between 04/05/2020 – 04/20/2020) </li>
  <li> Mean study days 412.85 (95\% CI: 233.4, 433.0) </li>
</ul>

## *Cohort 3 (N = 37)*
<ul>
  <li> 37 people beginning 09/30/2019 – 11/05/2020 </li>
  <li> Ending between 12/02/2019 – 04/20/2020 (All but 2 ended in March or April) </li>
  <li> Mean study days 178.35 (95\% CI: 79.7, 202.0) </li>
</ul>
...
tb1 <- table1(~ `Age` + `Sex` + `Race` + `Ethnicity` + `Marital Status` + 
              `Baseline Weight` + `Total Measures` + `Time Span` |`Cohort`,
